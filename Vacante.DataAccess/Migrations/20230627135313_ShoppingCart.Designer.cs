...
namespace Vacante.DataAccess.Migrations
{
    ...
    [Migration("20230627135313_ShoppingCart")]
            ...
            modelBuilder.Entity("VacanteAPP.Models.LastMinute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Descriere = "text",
                            DisplayOrder = 1,
                            LastMinuteDate = new DateTime(2023, 6, 27, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("VacanteAPP.Models.ShoppingCart", b =>
                {
                    ...
                    b.Property<int>("VacanteStandardVacantaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VacanteStandardVacantaId");
            ...
            modelBuilder.Entity("VacanteAPP.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("VacanteAPP.Models.VacanteStandard", "VacanteStandard")
                        .WithMany()
                        .HasForeignKey("VacanteStandardVacantaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
